...
let filesDrop = document.getElementById("files");
...
main.addEventListener("click", () => {
  ...
  hideElementVisibility(filesDrop);
...
filesSpan.addEventListener("click", () => {
  toggleElementVisibility(filesDrop);
  incrementIndexOnClick(filesDrop);
});
